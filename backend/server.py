...
# Configuration
ALLOWED_ORIGINS = os.getenv("ALLOWED_ORIGINS", "http://localhost:5173,http://localhost:3000,https://aud-isl-convo-106d0tju5-koushiks-projects-460d124f.vercel.app,https://aud-isl-convo.vercel.app").split(",")
